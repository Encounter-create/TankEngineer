...
export const MVP_COMMANDERS: Part[] = [
  ...
  },
  {
    ...
    rarity: 'legendary',
    weight: 2,
    description: '召唤3架轰炸机沿炮塔朝向飞过投弹。炸弹范围伤害+火圈。冷却60秒。🎯协同「精确打击」: 装备狙击炮管时投弹频率翻倍+垂直方向增加第二波3架轰炸机，形成十字交叉轰炸。',
    stats: { skillCdMs: 20000 },
  },
  {
    ...
    rarity: 'epic',
    weight: 2,
    description: '在当前位置部署一个自动炮塔，射程180px内自动索敌开火。炮塔有120HP，可被敌方攻击摧毁。冷却40秒。🏰协同「前线堡垒」: 装备重型底盘时，处于炮塔范围内每秒回复8HP，附带绿色治疗粒子效果。',
    stats: { skillCdMs: 20000 },
  },
  {
    id: 'commander_wizard',
    ...
    rarity: 'legendary',
    weight: 2,
    description: '复活最多3辆已被击毁的敌方坦克，保留原武器配置和AI参数。友军追随玩家：玩家在追踪圈(原敌攻击范围)内时警戒攻击视野内敌人，圈外时向玩家靠拢。💀协同「亡灵火箭」: 火箭击杀自动复活。',
    stats: { skillCdMs: 20000 },
  },
  {
    id: 'commander_ninja',
    ...
    rarity: 'epic',
    weight: 2,
    description: '在自身左右各召唤1个影分身(10s)，分身完全镜像玩家移动与射击，半透明无碰撞，HP为玩家1/4，敌方优先攻击分身。👥协同「影分身之术」: 装备冲刺底盘时前后左右共召唤4个分身。',
    stats: { skillCdMs: 20000 },
  },
  {
    id: 'commander_gravity',
    name: '重力指挥官',
    type: 'commander',
    rarity: 'legendary',
    weight: 2,
    description: '在鼠标位置制造重力井，持续3秒将周围敌人、方块和子弹全部吸向中心。物理混沌！',
    stats: { skillCdMs: 20000 },
  },
  {
    id: 'commander_time',
    ...
    rarity: 'epic',
    weight: 1,
    description: '扭曲时空3秒，所有敌方坦克移速×0.3、子弹速度×0.3。玩家不受影响。',
    stats: { skillCdMs: 20000 },
  },
  {
    id: 'commander_lightning',
    name: '闪电指挥官',
    type: 'commander',
    rarity: 'rare',
    weight: 1,
    description: '释放连锁闪电，在5个最近的敌人之间弹跳，每击100伤害。⚡协同「影分身之术」: 装备冲刺底盘时额外召唤上下2个影分身(10s)。',
    stats: { skillCdMs: 20000 },
  },
  {
    id: 'commander_restore',
    name: '复苏指挥官',
    type: 'commander',
    rarity: 'rare',
    weight: 1,
    description: '恢复半径150px内所有已摧毁的砖墙(恢复至满血50HP)。重建掩体！',
    stats: { skillCdMs: 20000 },
  },
  {
    id: 'commander_trisolaran',
    name: '三体人',
    type: 'commander',
    rarity: 'legendary',
    weight: 2,
    description: '以鼠标位置为中心召唤陨石！2秒锁定后巨大火球从左上45°加速砸落，落地瞬间毁灭范围内一切(友军和玩家除外)，留下持续10秒的火圈。冷却30秒。☄️特效：白十字闪烁→火球曳尾→白屏震屏→火海。',
    stats: { skillCdMs: 30000 },
  },
  {
    id: 'commander_bivector',
    name: '歌者',
    type: 'commander',
    rarity: 'legendary',
    weight: 2,
    description: '释放二向箔！12秒内战场剪切压缩成一条线，诗篇交替浮现，8秒白屏后5秒恢复。冷却60秒。',
    stats: { skillCdMs: 60000 },
  },
  {
    id: 'commander_quantum',
    name: '薛定谔',
    type: 'commander',
    rarity: 'legendary',
    weight: 2,
    description: '量子叠加态！5秒内画面红蓝双重曝光交替闪烁，振动渐强，5秒时波函数坍缩——50%敌人瞬间消亡。伴有一只量子小猫穿行而过🐱。冷却60秒。',
    stats: { skillCdMs: 60000 },
  },
  {
    id: 'commander_lens',
    ...
    rarity: 'legendary',
    weight: 2,
    description: '在鼠标位置制造引力透镜！2秒形成，6秒持续扭曲画面+敌人螺旋坠入，最后2秒坍缩。冷却80秒。',
    stats: { skillCdMs: 80000 },
  },
  {
    id: 'commander_poincare',
    name: '庞加莱',
    type: 'commander',
    rarity: 'legendary',
    weight: 2,
    description: '时间倒流5秒！子弹飞回、敌人退行、粒子倒流，倒流结束熵爆发——蓝色冲击波毁灭一切。冷却90秒。',
    stats: { skillCdMs: 90000 },
  },
  {
    id: 'commander_bigbang',
    name: '奇点',
    type: 'commander',
    rarity: 'legendary',
    weight: 2,
    description: '大爆炸！3秒万物坍缩至奇点→爆炸飞散+冲击波+火圈。冷却100秒。',
  ...
  },
  {
    ...
    rarity: 'legendary',
    weight: 2,
    description: '全息宇宙投影！3秒内战场被投影到旋转球体表面(经纬线+3D光影)，旋转3圈后球体裂解——所有敌人被撕碎。冷却120秒。',
    stats: { skillCdMs: 120000 },
  },
  {
    id: 'commander_trojan',
    name: '奥德修斯',
    ...
    rarity: 'legendary',
    weight: 2,
    description: '召唤特洛伊木马！巨型木马从左侧滑入，奥德修斯骑乘其上，侧门打开涌出6辆友军坦克。冷却80秒。',
    stats: { skillCdMs: 80000 },
  },
  {
    id: 'commander_noah',
    ...
    rarity: 'legendary',
    weight: 2,
    description: '大洪水！暴雨+水面攀升，敌人溺水+被浪拍击，退潮时被冲走。23s，冷却90秒。',
    stats: { skillCdMs: 90000 },
  },
  {
    id: 'commander_damocles',
    name: '达摩克利斯',
    type: 'commander',
    rarity: 'legendary',
    weight: 2,
