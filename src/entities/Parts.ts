...
export const MVP_COMMANDERS: Part[] = [
  ...
  },
  {
    ...
    rarity: 'epic',
    weight: 2,
    description: '分出一辆与自身完全相同配置的友军坦克。分身使用三态AI：追随玩家(100px内)→侦察巡逻→发现敌人开火(200px内)。🪞协同「镜面分身」: 装备反射管时，分身的炮管替换为反射管，双倍反弹火力覆盖战场。',
    stats: { skillCdMs: 20000 },
  },
  {
  ...
  },
  {
    ...
    rarity: 'rare',
    weight: 1,
    description: '释放连锁闪电，在5个最近的敌人之间弹跳。首击40伤害，每跳伤害递减20%。',
    stats: { skillCdMs: 20000 },
  },
  {
